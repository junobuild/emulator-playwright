...
export class ConsolePage extends BrowserPage {
  private constructor(params: BrowserPageParams) {
    super(params);
  }

  static async initWithSignIn(params: BrowserPageParams): Promise<ConsolePage> {
